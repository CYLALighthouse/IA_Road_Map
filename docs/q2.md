...
Please note that data indicators are not definitive criteria for selecting a focus list student. ACMs should also consider partner teacher input and their own observations. However our state commission grant expects us to work with focus list students who are "off track" in the area we are providing services. If student data is not available on Power BI, ACMs should try to get this data from their partner teachers. If data is not available at the time of focus list selection use your partner teachers and in class observations to make the best selections possible.
...
<img src="_images/app-launcher.PNG" alt="app-launcher" style="width:40%;"/>
