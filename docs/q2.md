...
|[ ]| IUSD ACMs use Mosaic to access student data | TBD| [Mosaic Trainings](https://bit.ly/395T2Dx) |
...
1. Visit [app.powerbi.com](https://app.powerbi.com/home) OR find the yellow Power BI icon in the app launcher found on the top lef-hand corner of your outlook email or on any page on cyconnect
...
DESSA accounts: The DESSA administrators Aperture Education have sent out account activation emails to PMs and corps members with the subject line "Your Aperture User Signup Invitation.” Emails should have been sent to ACMs and PMs on 9/1 and 9/2 and need to be activated before 9/15. Please have ACMs follow the [guide](https://bit.ly/394dtkv) to activate their DESSA accounts. PMs should also activate their accounts through the same process. Contact Impact Analytics if you or your ACMs have trouble creating accounts and see this [quick walkthrough video](https://bit.ly/3k8BWLy). If anyone needs their invitation sent out again, please contact Chris Bischel.The first DESSA administration will be in late November. 